...
class LightModeColors {
  ...
  static const lightPrimaryDark = Color(0xFF4C51BF);
  ...
  // Surface and background: Off-white
...
class DarkModeColors {
  // Primary: Lighter indigo for dark background
  static const darkPrimary = Color(0xFFA5B4FC);
  static const darkPrimaryDark = Color(0xFF818CF8);
  static const darkOnPrimary = Color(0xFF1E1B4B);
  static const darkPrimaryContainer = Color(0xFF4C51BF);
  static const darkOnPrimaryContainer = Color(0xFFE0E7FF);

  // Secondary: Teal
  static const darkSecondary = Color(0xFF5EEAD4);
  static const darkOnSecondary = Color(0xFF0F766E);
  ...
  static const darkSurface = Color(0xFF1A1A23);
  static const darkOnSurface = Color(0xFFF1F5F9);
  static const darkBackground = Color(0xFF0F0F14);
  static const darkSurfaceVariant = Color(0xFF27272F);
  ...
  static const priorityHigh = Color(0xFFFCA5A5);
  static const priorityMedium = Color(0xFFFBBF24);
  static const priorityLow = Color(0xFF6EE7B7);
}
